      ...
      <div className="flex flex-wrap -m-4 w-full pb-10">
        {data.ownersData && data.ownersData.map((owner) => (
            <div className="xl:w-1/3 md:w-1/2 p-4 relative">
              ...
              <svg className="absolute right-0 bottom-0 h-5 w-5 m-10 text-gray-600 hover:cursor-pointer" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" onClick={() => { setSidePanelJSON(owner); setSidePanelState(true); }}>
      ...
      <div className="flex flex-wrap -m-4 w-full pb-10">
        {data.balancesData && data.balancesData.map((balance) => (
            <div className="xl:w-1/3 md:w-1/2 p-4 relative">
              ...
              <svg className="absolute right-0 bottom-0 h-5 w-5 m-10 text-gray-600 hover:cursor-pointer" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" onClick={() => { setSidePanelJSON(balance); setSidePanelState(true); }}>
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
              </svg>
            </div>
      ...
      <div className="flex flex-wrap -m-4 w-full pb-10">
        {data.statementsData && data.statementsData.map((statement) => (
            <div className="xl:w-1/3 md:w-1/2 p-4 relative">
              ...
              <svg className="absolute right-0 bottom-0 h-5 w-5 m-10 text-gray-600 hover:cursor-pointer" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" onClick={() => { setSidePanelJSON(statement); setSidePanelState(true); }}>
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
              </svg>
            </div>
